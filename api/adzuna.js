...
export default async function handler(req, res) {
  ...
  try {
    ...
    const {
      ...
      experience = "",      // 1, 2, 3
      entreprise = "",      // filtre nom entreprise (post-filtrage)
    ...
    const offers = allResults.map((o) => ({
      ...
      lat: (o.lieuTravail && o.lieuTravail.latitude) || null,
      lon: (o.lieuTravail && o.lieuTravail.longitude) || null,
      codePostal: (o.lieuTravail && o.lieuTravail.codePostal) || "",
    ...
    // Post-filtrage par nom d'entreprise si demandé
    const filtered = entreprise
      ? offers.filter((o) => (o.entreprise || "").toLowerCase().includes(entreprise.toLowerCase()))
      : offers;
